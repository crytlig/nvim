...
return {
  ...
  opts = {
    ...
    handlers = {
      ...
      -- rust_analyzer = false, -- setting a handler to false disables that language server
      -- pyright = function(server) vim.lsp.enable(server) end -- custom per-server handler
    },
